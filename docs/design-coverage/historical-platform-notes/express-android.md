<!--
  ...
  Origin: extracted from Express-Android PR #5190 in early 2026 as the
  Android hint shipped with the skill. Wave 2 of the design-coverage
  improvements (issue prpande/skills#12) moved per-platform hints into
  the consuming repo (auto-generated by design-coverage-scout) and
  removed all shipped hints. This file documents what platform knowledge
  looked like before the scout absorbed it.

  See docs/superpowers/plans/2026-04-25-design-coverage-wave-2-implementation.md
