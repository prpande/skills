...
**Interfaces:**
- Consumes: `poll.fetch_pr` and `poll.run_gh` (Task 3); `skills/team-tooling/slack-reply/SKILL.md`, `skills/team-tooling/slack-reply/references/shapes.md`, `skills/team-tooling/slack-reply/references/corpus-notes.md`; the `humanizer` skill's catalogue.
...
Read `skills/team-tooling/slack-reply/SKILL.md`, `skills/team-tooling/slack-reply/references/shapes.md`, `skills/team-tooling/slack-reply/references/corpus-notes.md`, and the `humanizer` skill's SKILL.md. Take from `slack-reply` its answer-first rule, its tier and word-budget idea, its shapes, and its audit checklist; from `humanizer` the highest-frequency tells. Translate Slack formatting to GitHub markdown (backticks and fenced blocks stay; no Slack mrkdwn).
...
- Nothing posted on GitHub carries a marker, a template, a fixed prefix,
  ...
  `skills/pr-tooling/pr-watch/references/reply-voice.md`.
...
1. Write the reply from the return's `verdict`, `reason`, `reply_text`
   ...
   `skills/pr-tooling/pr-watch/references/reply-voice.md`. Run its audit and its last step.
...
5. For each finding, one reply on its thread written with
   `skills/pr-tooling/pr-watch/references/reply-voice.md` (shape: re-review verdict), posted
